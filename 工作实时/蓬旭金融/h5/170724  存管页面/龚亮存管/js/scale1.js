(function(window, undefined){
	...
	var ImagesZoom1 = function(){};

	ImagesZoom1.prototype = {
		// 给初始化数据
		init: function(param){
			var self   = this,
				params = param || {};
			...
			var imgList   = document.querySelectorAll(params.elem + " img"),
				zoomMask  = document.querySelector(".imgzoom_pack1"),
				zoomImg   = document.querySelector(".imgzoom_pack1 .imgzoom_img img"),
				zoomClose = document.querySelector(".imgzoom_pack1 .imgzoom_x"),
				imgSrc    = "";
		...
		addEventStart: function(param){
			...
			self.element = document.querySelector(".imgzoom_pack1 img");
	...
	window.ImagesZoom1 = new ImagesZoom1();
})(this);
