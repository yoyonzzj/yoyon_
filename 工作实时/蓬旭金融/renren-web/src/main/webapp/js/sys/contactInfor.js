...
var vm = new Vue({
    ...
    function add(userId){
    	...
    	$.post('/zyUser/userContactAdditional?userId='+userId,function(data){
    		var obj = data.result;
    		$("#contactAdr").html("").append(obj.contactAdr);
    		$("#contactTel").html("").append(obj.contactTel);            
    		$("#unitName").html("").append(obj.unitName);        
    		$("#unitAdrDetail").html("").append(obj.unitAdrDetail);
    		$("#unitPhone").html("").append(obj.unitPhone);
    	})
    }
