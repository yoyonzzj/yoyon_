$(function () {
    $("#jqGrid").jqGrid({
        url: '/zyuserwithdrawals/getWithdrawalsListNoCondition',
        postData:{'page':1, 'limit':10,'sidx':'','order':'','phone':'','userStatus':'','startTime':'','endTime':''},
        datatype: "json",
        colModel: [		
            { label: '用户手机号码', name: 'phone', width:140}, 
			...
			{ label: '申请提现金额', name: 'applicationMoney', width:110}, 			
			{ label: '账户余额', name: 'accountBalance', width:90}, 			
			{ label: '可用余额', name: 'availableBalance', width:90}, 			
			{ label: '冻结金额', name: 'freezeMoney', width:90},	
...
$("#chaxun").click(function(){
	...
	var endTime=document.querySelector('#datetimeEnd').value;
	 $('#jqGrid').jqGrid('setGridParam',{  
	        datatype:'json',
	        page:1,
	        url: '/zyuserwithdrawals/getWithdrawalsList',
