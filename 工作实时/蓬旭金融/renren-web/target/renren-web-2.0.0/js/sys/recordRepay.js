$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '还款到期时间', name: 'refundTime',align:'center', width: 160},
			{ label: '还款本金', name: 'refundPrinciple', align:'center',width: 90},
			{ label: '还款利息', name: 'interest',align:'center', width: 90},
			{ label: '还款管理费用', name: 'managementCost',align:'center', width: 130},
			...
			{ label: '还款时间', name: 'grantDate',align:'center', width: 90},
