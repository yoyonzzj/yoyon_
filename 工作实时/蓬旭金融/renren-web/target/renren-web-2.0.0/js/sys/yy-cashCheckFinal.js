$(function () {
    $("#jqGrid").jqGrid({
        url: '/zyuserwithdrawals/finalExamineList',
        ...
        colModel: [		
			...
			{ 
				label: '初审状态', 
				name: 'firstWithdrawalsStatus',
				formatter : function(cellvalue, options, rowObject){
            		if (rowObject.firstWithdrawalsStatus == 0){
            			var html='<a href="javascript:void(0)" style="color:#4F66FF;text-decoration:none;font-weight:bold">通过</a>';
            		}else if(rowObject.firstWithdrawalsStatus == 1){
            			var html='未通过';
            		}else{
            			var html='初审中';
            		}
			...
			{ 
				label: '复审状态', 
				name: 'secondWithdrawalsStatus',
				formatter : function(cellvalue, options, rowObject){
            		if (rowObject.secondWithdrawalsStatus == 0){
            			var html='<a href="javascript:void(0)" style="color:#4F66FF;text-decoration:none;font-weight:bold">通过</a>';
            		}else if(rowObject.secondWithdrawalsStatus == 1){
...
$("#butongguo").click(function(shenhemoney,shenheid){
	var shenhemoney=$("#optionFund").find("option:selected").text();
	var shenheid=$("#check-yincang").text();
