$(function () {
    $("#jqGrid").jqGrid({
        url: '/zyuserwithdrawals/secondExamineList',
        ...
        colModel: [		
			...
			{ label: '账户余额', name: 'accountBalance', width:84}, 			
			{ label: '可用余额', name: 'availableBalance', width:84}, 			
			{ label: '冻结金额', name: 'freezeMoney', width:82},	
			{ label: '申请时间', name: 'createDate', width:180},
			...
			{ 
				label: '初审状态', 
				name: 'withdrawalsstatus',
				formatter : function(cellvalue, options, rowObject){
            		if (rowObject.withdrawalsstatus == 0){
            			var html='初审中';
            		}else if(rowObject.withdrawalsstatus == 1){
            			var html='<a href="javascript:void(0)" style="color:red;text-decoration:none;font-weight:bold">未通过</a>';
            		}else if(rowObject.withdrawalsstatus == 2){
			...
			{ 
				...
				name: 'createDate2', 
				formatter: function(cellvalue, options, rowObject){
					var html='<a href="javascript:void(0)" data-toggle="modal" data-target=".bs-example-modal-lg" onclick="check('+"'"+rowObject.withdrawalsId+"'"+')"">审核</a>';
					return html
				}, width:70
			}
        ],
...
$("#tongguo").click(function(shenhemoney,shenheid){
	...
	$.post('/zyuserwithdrawals/secondExamine?withdrawalsId='+shenheid+'&withdrawalsStatus=4',function(data){
//		if(data.code==0){
//			alert("审核通过");
//		}else{
//			alert("信息填写有误");
...
$("#butongguo").click(function(shenhemoney,shenheid){
	var shenhemoney=$("#optionFund").find("option:selected").text();
	var shenheid=$("#yincang").text();
	$.post('/zyuserwithdrawals/secondExamine?withdrawalsId='+shenheid+'&withdrawalsStatus=3',function(data){
//		if(data.code==0){
//			alert("审核不通过");
//		}else{
//			alert("信息填写有误");
