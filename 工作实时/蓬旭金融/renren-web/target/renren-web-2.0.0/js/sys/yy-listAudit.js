$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [		
			...
			{ label: '申请金额', name: 'verifyMoney', width:84}, 			
			{ label: '申请期限', name: 'borrowPeriods', width:84}, 			
			{ label: '申请时间', name: 'createTime', width:182}, 			
			{ label: '还款总额', name: 'refundLimit', width:82},	
			{ label: '还款期限', name: 'refundTime', width:182},
			...
			{ 
				...
				name: 'createDate2', 
				formatter: function(cellvalue, options, rowObject){
					var html='<a href="javascript:void(0)" data-toggle="modal" data-target=".bs-example-modal-lg" onclick="check('+"'"+rowObject.id+"'"+')"">初审</a>';
					return html
				}, width:65
			}
        ],
...
$("#chaxun").click(function(){
	...
	var endTime=document.querySelector('#datetimeEnd').value;
	 $('#jqGrid').jqGrid('setGridParam',{  
	        datatype:'json',
	        page:1,
	        url: '/zyuserverify/waitVerifyDemand',
