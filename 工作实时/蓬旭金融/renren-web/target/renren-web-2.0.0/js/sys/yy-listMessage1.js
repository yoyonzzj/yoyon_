$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			...
			{ label: '排序', name: 'sort', width:233 , index: "rownum" }, 			
...
//			var selectedId = $("#jqGrid").jqGrid("getGridParam", "selarrrow");  
...
//        		    data: {'title':title, 'url':url,'sort':sort,'bannerId':bannerId,
//        		    	'flag':flag,'author':author,'pic':pic},
        		    dataType:'json',
